...
index 70e84b5..ebd94d1 100644
--- a/sqlite3.c
+++ b/sqlite3.c
@@ -153735,6 +153735,8 @@ SQLITE_PRIVATE int sqlite3StmtVtabInit(sqlite3*);
...
@@ -156980,6 +156982,10 @@ static int openDatabase(
   }
 #endif
...
@@ -180224,6 +180230,126 @@ SQLITE_API int sqlite3_json_init(
