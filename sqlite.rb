...
index 9c8fd62..e846a85 100644
--- a/sqlite3.c
+++ b/sqlite3.c
@@ -140500,6 +140500,8 @@ SQLITE_PRIVATE int sqlite3Json1Init(sqlite3*);
...
@@ -143521,6 +143523,10 @@ static int openDatabase(
   }
 #endif
...
@@ -181832,6 +181838,126 @@ SQLITE_API int sqlite3_json_init(
