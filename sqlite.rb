...
index 7b525c3..4a7c74e 100644
--- a/sqlite3.c
+++ b/sqlite3.c
@@ -151796,6 +151796,8 @@ SQLITE_PRIVATE int sqlite3StmtVtabInit(sqlite3*);
...
@@ -154994,6 +154996,10 @@ static int openDatabase(
   }
 #endif
...
@@ -178091,6 +178097,126 @@ SQLITE_API int sqlite3_json_init(
